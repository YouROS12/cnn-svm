...
## 🆕 New Experiment: Contrastive Learning + SVM

**NEW!** We've added a novel experiment combining contrastive learning (SimCLR) with SVM classification for plant disease detection:

📁 **[Contrastive SVM Experiment](contrastive_svm_experiment/)** - Margin-Aware Contrastive Learning with SVM

**Key Features:**
- Self-supervised contrastive pretraining
- SVM classification with maximum margin properties
- Superior few-shot learning performance
- Ready for Google Colab
- Publication-ready (targeting Q1 journals)
...
See the [experiment folder](contrastive_svm_experiment/) for complete documentation and implementation.
